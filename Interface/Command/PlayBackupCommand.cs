...
{
    public class PlayBackupCommand : ICommand
    {
        ...
        public PlayBackupCommand(BackupController backupController, IEnumerable<string> backupNames, Action<bool> togglePause)
        {
